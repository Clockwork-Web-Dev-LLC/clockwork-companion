...
class ActivityPage
{
    ...
    /**
     * Compact status for the wp-admin dashboard widget — count of action-log
     * rows (scans, backups, uptime checks, etc.) recorded so far this month.
     *
     * @return array{tasksThisMonth: int}
     */
    public static function summary(): array
    {
        ...
        return ['tasksThisMonth' => Repository::countInWindow($start, $end)];
    }
    ...
    private static function typeIcon(string $icon): string
    {
        $svgs = [
            ...
            'pulse'    => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12h4l3 8l4 -16l3 8h4"/></svg>',
